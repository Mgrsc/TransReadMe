...
This project aims to use the OpenAI API to translate a source README file into multiple languages and generate corresponding README files. This script automatically detects the language of the source README and generates translated versions in the target languages.

## Features

- Automatically detects the language of the source README
- Translates the README file into multiple target languages
- Saves the translated README files to a specified directory
- Generates a README in the default display language to the root directory
...
- Copy or translate the README file of the default display language and save it to README.md in the root directory of the repository.
